...
# NS_LOG="MacLow=level_function|time|node|func:ChannelAccessManager=level_warn|time|node|func" 
# ./waf --run "simple-ofdma-adhoc4 --ofdmaEnabled=true --startTime=60 --totalTime=120 --packetSize=4e3 --dataMode=HeMcs4 --datarate=25e5 --ratio=0.375 --RngRun=11 --locationFile=./locationtxt/locationFile23.txt --routingFile=./locationtxt/routingFile23.txt --tcp=1 --qosDisabled=true" &> debug-ofdma2.txt