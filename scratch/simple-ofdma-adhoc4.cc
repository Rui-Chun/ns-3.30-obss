...
int main (int argc, char **argv)
{
  ...
  if (locationFile.empty ())
    ...
    {
      NS_ASSERT_MSG (locations.size () >= apNum+clNum, "not enough input locations");
  ...
  // Use APSTA to replace ADHOC
  WifiMacHelper mac;
  Ssid ssid = Ssid ("ap0");
  mac.SetType ("ns3::ApWifiMac",
               "Ssid", SsidValue (ssid),
               "OfdmaSupported", BooleanValue (ofdmaEnabled));
  apDevices.Add (wifi.Install (phy, mac, nodes.Get (0)));
  mac.SetType ("ns3::StaWifiMac",
               "Ssid", SsidValue (ssid),
               "OfdmaSupported", BooleanValue (ofdmaEnabled));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (1)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (2)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (3)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (4)));

  ssid = Ssid ("ap1");
  mac.SetType ("ns3::ApWifiMac",
               "Ssid", SsidValue (ssid));
  apDevices.Add (wifi.Install (phy, mac, nodes.Get (1)));
  mac.SetType ("ns3::StaWifiMac",
               "Ssid", SsidValue (ssid));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (5)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (6)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (7)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (8)));

  ssid = Ssid ("ap2");
  mac.SetType ("ns3::ApWifiMac",
               "Ssid", SsidValue (ssid));
  apDevices.Add (wifi.Install (phy, mac, nodes.Get (2)));
  mac.SetType ("ns3::StaWifiMac",
               "Ssid", SsidValue (ssid));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (9)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (10)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (11)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (12)));

  ssid = Ssid ("ap3");
  mac.SetType ("ns3::ApWifiMac",
               "Ssid", SsidValue (ssid));
  apDevices.Add (wifi.Install (phy, mac, nodes.Get (3)));
  mac.SetType ("ns3::StaWifiMac",
               "Ssid", SsidValue (ssid));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (13)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (14)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (15)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (16)));

  ssid = Ssid ("ap4");
  mac.SetType ("ns3::ApWifiMac",
               "Ssid", SsidValue (ssid));
  apDevices.Add (wifi.Install (phy, mac, nodes.Get (4)));
  mac.SetType ("ns3::StaWifiMac",
               "Ssid", SsidValue (ssid));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (17)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (18)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (19)));
  clDevices.Add (wifi.Install (phy, mac, nodes.Get (20)));
  ...
  interfaces.Add (apInterfaces.Get (0));
